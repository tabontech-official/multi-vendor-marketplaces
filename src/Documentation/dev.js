          ...
          {selected === "unpublished" ? (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
              ...
              <div className="bg-white rounded-md shadow-md p-6">
                ...
                <div className="bg-blue-50 border-l-4 border-blue-500 p-4 text-sm text-blue-800 rounded-md mt-6">
                  <strong>Note:</strong> Returns <code>404</code> if the product
                  or config is missing. Returns <code>400</code> if Shopify
                  update fails.
                </div>
              </div>
          ...
          {selected === "deleteProduct" ? (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
              ...
              <div className="bg-white rounded-md shadow-md p-6">
                ...
                {/* Note */}
                <div className="bg-blue-50 border-l-4 border-blue-500 p-4 text-sm text-blue-800 rounded-md mt-6">
                  <strong>Note:</strong> If the product is not found, the API
          ...
          {selected === "addImageGallery" ? (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
              ...
              <div className="bg-white rounded-md shadow-md p-6">
                ...
                {/* Description */}
                <p className="text-gray-700 text-sm mb-4">
                  Adds one or more image URLs to the user's image gallery. If
                  the gallery already exists, new images are appended (excluding
                  duplicates).
                </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
              ...
              <div className="bg-white rounded-md shadow-md p-6">
                ...
                <p className="text-gray-700 text-sm mb-4">
                  ...
                  is provided, it filters to images assigned to that product or
                  global (no productId). Otherwise, it filters for
                  Cloudinary/Shopify-hosted images.
                </p>
          ...
          {selected === "productBulkUpload" ? (
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
              ...
              <div className="bg-white rounded-md shadow-md p-6">
                ...
                {/* Description */}
                <p className="text-gray-700 text-sm mb-4">
                  Accepts a CSV file with product details. Products are grouped
                  by <code>Handle</code>. If the product exists, it's updated;
                  otherwise, it's created. Variant images are uploaded and
                  linked. Tags and metafields are applied.
                </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
              ...
              <div className="bg-white rounded-md shadow-md p-6">
                ...
                <div className="mb-4">
                  ...
                  <p className="mt-1 text-xs text-gray-500">
                    Returns a specific variant's full information from the
                    listing model, including price, SKU, options, and inventory.
                  </p>
                </div>
                ...
                <p className="text-gray-700 text-sm mb-4">
                  ...
                  <code>listingModel</code> to locate the exact variant using
                  <code>productId</code> and <code>variantId</code>, and returns
                  its detailed data including variant fields, all product
                  options, and associated product images.
                </p>
                ...
                <ul className="text-sm text-gray-700 space-y-2 mb-4">
                  <li>
                    <strong>productId</strong>{" "}
                    <span className="text-gray-500">(string, required)</span> –
                    ID of the product that owns the variant.
                  </li>
                  <li>
                    <strong>variantId</strong>{" "}
                    <span className="text-gray-500">(string, required)</span> –
                    ID of the specific variant to fetch.
                  </li>
                </ul>

                {/* Note */}
                <div className="bg-blue-50 border-l-4 border-blue-500 p-4 text-sm text-blue-800 rounded-md mt-6">
                  <strong>Note:</strong> This endpoint reads from MongoDB only
                  and does not fetch from Shopify directly. Useful for local
                  dashboards, variant editors, and admin panels.
                </div>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
              ...
              <div className="bg-white rounded-md shadow-md p-6">
                ...
                <ul className="text-sm text-gray-700 space-y-2">
                  ...
                  <li>
                    <strong>option1</strong>{" "}
                    <span className="text-gray-500">(string)</span> – First
                    option (e.g. Color)
                  </li>
                  <li>
                    <strong>option2</strong>{" "}
                  ...
                  <li>
                    <strong>option3</strong>{" "}
                    <span className="text-gray-500">(string)</span> – Third
                    option (optional)
                  </li>
                  <li>
                    <strong>weight</strong>{" "}
                ...
                {/* Note */}
                <div className="bg-blue-50 border-l-4 border-blue-500 p-4 text-sm text-blue-800 rounded-md mt-6">
                  <strong>Note:</strong> Inventory is updated separately using
                  the Shopify Inventory API after variant update.
                </div>
              </div>
...
// Helper component for code cards
