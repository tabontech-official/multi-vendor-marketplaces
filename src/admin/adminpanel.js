...
const AdminDashboard = () => {
  ...
  const handleSave = async () => {
    try {
      await axios.put('http://localhost:8000/auth/shopifyConfigurations', {
        shopifyAccessToken,
        shopifyApiKey,
        shopifyStoreUrl
      });
  ...
  const fetchPrice = async () => {
    try {
      const response = await fetch(
        "http://localhost:8000/product/getPrice/",
        { method: "GET" }
      );
  ...
  const handleConfirmChangePrice = async () => {
    ...
    try {
      const response = await fetch(
        "http://localhost:8000/product/updateId/",
        {
          method: "PUT",
          headers: {
  ...
  const fetchRequiredCredits = async () => {
    try {
      const response = await fetch(
        "http://localhost:8000/product/fetchRequireCredits",
        { method: "GET" }
      );
  ...
  const handleSetPrice = async (productname, price) => {
    ...
    try {
      const response = await fetch(
        "http://localhost:8000/product/credits/",
        {
          method: "PUT",
          headers: {
            "Content-Type": "application/json",
  ...
  const sendCredit = async () => {
    ...
    try {
      const response = await fetch(
        "http://localhost:8000/auth/updatequantity",
        {
          method: "PUT",
          headers: {
