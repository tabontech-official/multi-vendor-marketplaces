...
const SettingsSidebar = () => {
  ...
  return (
    <aside className="w-52 bg-gradient-to-b from-gray-50 to-gray-200 h-screen sticky top-0 flex flex-col border-r border-gray-300 shadow-sm">
      <div className="p-6">
            ...
            className={({ isActive }) => {
              const isPayoutActive =
                ...
                (window.location.pathname === "/payout" ||
                  window.location.pathname === "/payout-details");

              return `group flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm font-medium transition-all duration-200
      ${
        isActive || isPayoutActive
          ...
          >
            {({ isActive }) => (
              <>
                <span
                  className={`text-xl ${isActive ? "text-gray-100" : "text-gray-500 group-hover:text-gray-700"}`}
                >
                  {item.icon}
                </span>
