  ...
  return (
    <div className="flex">
      ...
      <div className="max-w-3xl mx-auto space-y-6">
        <div>
          <h1 className="text-3xl font-bold text-gray-800 mb-2">API Credentials</h1>
        ...
        <div className="bg-white border border-gray-200 rounded-lg shadow p-6 space-y-6">
          ...
          <div>
            <label className="text-sm text-gray-600 mb-1 block">API Secret Key</label>
            <div className="relative">
              <input
            ...
            <p className="text-xs text-gray-500 mt-1">Created about 20 hours ago</p>
          </div>
        </div>

        <div className="bg-white border border-gray-200 rounded-lg shadow p-6">
          <h3 className="text-base font-medium text-gray-800 mb-2">Rotate App Credentials</h3>
          <p className="text-sm text-gray-600 mb-4">
            Generate a new secret key or refresh token without causing downtime for merchants.
            Always generate new tokens before deleting old ones.
          </p>
