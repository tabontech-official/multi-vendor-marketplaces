...
import { FaShopify, FaRocket, FaMobileAlt, FaCogs, FaChartLine } from 'react-icons/fa';

const EcommerceConsultation = () => {
  const [formData, setFormData] = useState({
    name: '', email: '', storeUrl: '', type: '', message: ''
  });
    ...
    <main className="w-full p-4 md:p-8">
        <div className="flex flex-col md:flex-row md:justify-between items-start border-b-2 border-gray-200 pb-4">
          <div className="flex-1">
            <h1 className="text-2xl font-semibold mb-1">1-on-1 E-commerce Consultations</h1>
            <p className="text-gray-600">          Get expert guidance on improving your Shopify store, increasing sales, or scaling your brand.</p>
      ...
      <section className="bg-white shadow-md rounded-2xl p-8 border border-gray-100">
        <h2 className="text-2xl font-bold text-gray-800 mb-6">What's Included in Your Consultation</h2>
        <ul className="space-y-5 text-gray-600 text-sm">
          <li className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-xs">Full UX + performance review of your Shopify store</p>
            </div>
          </li>
          <li className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-xs">We help plan your customer journey for conversions</p>
            </div>
          </li>
          <li className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-xs">Speed testing and layout improvements for mobile</p>
            </div>
          </li>
          <li className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-xs">Tools, themes & apps best suited for your store's growth</p>
            </div>
          </li>
          <li className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-xs">Custom tips to boost traffic & increase sales</p>
            </div>
          </li>
        </ul>
      </section>
      ...
      <section className="bg-gray-50 shadow-inner rounded-2xl p-8 border border-gray-200">
        <h2 className="text-xl font-semibold text-gray-800 mb-4">Book Your Free Consultation</h2>
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label className="text-sm block mb-1 font-medium">Your Store URL</label>
            <input type="text" name="storeUrl" placeholder="https://yourstore.myshopify.com"
              value={formData.storeUrl} onChange={handleChange}
              className="mt-1 w-full px-4 py-3 border rounded-md focus:outline-none focus:ring-2 focus:ring-cyan-500"
              />
          </div>
          <div>
            <label className="text-sm block mb-1 font-medium">Consultation Type</label>
          ...
          <div>
            <label className="text-sm block mb-1 font-medium">Tell us your goals</label>
            <textarea name="message" rows="4" placeholder="I want to improve speed and get more conversions..."
