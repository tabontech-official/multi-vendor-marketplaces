...
//                   style={{
//                     width: `${productCount ? (productActiveCount / productCount) * 100 : 0}%`,
//                   }}
//                 />
//                 <div
//                   className="h-full bg-slate-300 transition-all duration-500"
//                   style={{
//                     width: `${productCount ? (productInActiveCount / productCount) * 100 : 0}%`,
//                   }}
//                 />
//               </div>
//             </div>
...
//                 <span className="text-[10px] uppercase text-gray-700 font-bold">
//                   Inactive
//                 </span>
...
const MainDashboard = () => {
  ...
  return (
    <main className="w-full p-4 ">
      ...
      <div className="flex gap-6 mt-6">
  {/* LEFT CARD - REVENUE */}
  <div className="bg-gray-100 p-6 rounded-xl shadow-sm w-[65%] h-[50vh] flex flex-col">
    <div className="flex justify-between items-center mb-4">
      <h2 className="text-lg font-semibold text-gray-700">
        Monthly Recurring Revenue
      </h2>
    ...
    {/* Chart container needs to flex to fill the remaining height */}
  ...
  <div className="bg-gray-100 border border-slate-200 p-6 rounded-2xl shadow-sm w-[35%] min-w-[320px] font-sans text-slate-800 h-[50vh] flex flex-col justify-between">
    {/* Header */}
    <div className="flex justify-between items-center">
      ...
      <span className="bg-white border border-slate-200 text-gray-600 text-xs font-medium px-3 py-1.5 rounded-lg shadow-sm">
        This Month
      </span>
    </div>
    ...
    <div className="flex items-center gap-6 my-4">
      <div className="relative flex items-center justify-center">
        ...
        <div className="absolute -z-10 w-20 h-20 bg-cyan-400/20 blur-xl rounded-full"></div>
      </div>
    ...
    <div className="space-y-4 bg-white p-4 rounded-xl border border-slate-100">
      <div className="space-y-2">
        ...
        <div className="flex w-full h-2 bg-slate-100 rounded-full overflow-hidden">
          <div
            className="h-full bg-cyan-500 transition-all duration-500"
            style={{
              width: `${productCount ? (productActiveCount / productCount) * 100 : 0}%`,
